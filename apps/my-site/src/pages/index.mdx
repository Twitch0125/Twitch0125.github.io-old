...
<Subheading style="margin-top: -0.75rem">Oct 2019 - Current | Frontend Development · UX/UI Design · Node.js</Subheading>
...
- Worked with software architect to convert hundreds of JSP templates to Vue components to decouple our monolith.
	- Allowed us to progressively turn our frontend into a Nuxt app
